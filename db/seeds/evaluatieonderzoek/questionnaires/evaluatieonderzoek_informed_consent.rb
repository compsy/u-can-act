  ...
  <ol class="flow-text">
    ...
    <li>Deelname aan dit onderzoek betekent het volgende:
      <ol>
        ...
        <li>Het staat mij vrij om mijn e-mailadres op te geven aan het einde van het onderzoek, indien ik hiervoor kies wordt ook mijn IP-adres opgeslagen. Dit is nodig om eenmalig aanspraak te kunnen maken op een bol.com cadeaubon ter waarde van €10,-. Deze persoonsgegevens worden apart van de onderzoeksdata opgeslagen en deze twee vormen van data zijn niet aan elkaar te koppelen. Het is mij duidelijk dat het opgeven van mijn e-mailadres geheel vrijwillig is: ik mag er ook voor kiezen om dit niet in te vullen. In dat geval kan ik geen beloning ontvangen, maar wel meedoen aan het onderzoek.
        </li>
      </ol>
    </li>
