...
vm_measurement = mentor_protocol.measurements.find_by_questionnaire_id(voormeting_id)
vm_measurement ||= mentor_protocol.measurements.build(questionnaire_id: voormeting_id)
vm_measurement.open_from_offset = 2.days + 17.hours + 15.minutes # Wednesday 17:15
