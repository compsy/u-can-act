...
content = <<~'END'
  ...
  <li>De onderzoeker zal verdere vragen over het onderzoek nu of gedurende het onderzoek beantwoorden. Vragen over het onderzoek kunnen ook achteraf gesteld worden, via <a href="mailto:j.r.den.hartigh@rug.nl>j.r.den.hartigh@rug.nl</a>.</li>
  </ol>
END
