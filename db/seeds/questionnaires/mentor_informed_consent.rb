...
ic_content = <<~'END'
  ...
  <ol class="flow-text">
    ...
    <li>Deelname aan dit onderzoek betekent het volgende:
      <ol>
        <li>Ik zal elke week voor iedere jongere die ik begeleid en tevens mee doet aan dit onderzoek één vragenlijst invullen, voor 30 weken in totaal. Deze vragenlijst duurt per jongere ongeveer twee minuten.
        </li>
