ic_name = 'informed consent studenten second wave'
...
ic_content = <<~'END'
  ...
  <ol class="flow-text">
    ...
    <li>Deelname aan dit onderzoek betekent het volgende:
      <ol>
        <li>
        Ik zal elke week één vragenlijst invullen, tot en met de maand juli of totdat ik zomervakantie heb. Deze vragenlijst duurt ongeveer twee minuten.
        </li>
