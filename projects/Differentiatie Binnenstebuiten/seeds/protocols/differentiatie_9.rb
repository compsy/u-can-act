...
def create_protocol(pr_name, db_name, ic_name, invitation_text)
  default_protocol_duration = (Date.new(2019,4,10) - Date.new(2018,10,29)).to_i
  ...
  offsets << 2.days + 12.hours # Wednesdays at 12:00
  reminder_delays << 5.hours  # Wednesdays at 17:00
  open_durations << 11.hours 

  offsets << 3.days + 12.hours # Thursdays at 12:00
  reminder_delays << 5.hours  # Thursdays at 17:00
  open_durations << 11.hours 
...
pr_name = 'differentiatie_studenten_9'
...
pr_name = 'differentiatie_docenten_9'
