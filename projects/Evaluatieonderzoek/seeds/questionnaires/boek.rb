...
boek1_content = [
  {
    ...
    required: true,
    title: '',
    options: ['Ik geef hierbij toestemming om  mijn gegevens te gebruiken voor het toesturen van het boek.'],
    show_otherwise: false
  },
]
