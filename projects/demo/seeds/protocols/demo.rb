...
demo_solo_protocol = Protocol.find_by_name(pr_name)
demo_solo_protocol ||= Protocol.new(name: pr_name)
demo_solo_protocol.duration = 1.day
demo_solo_protocol.informed_consent_questionnaire = Questionnaire.find_by_name('demo-ic')
...
demo_measurement = demo_solo_protocol.measurements.find_by_questionnaire_id(questionnaire_id)
