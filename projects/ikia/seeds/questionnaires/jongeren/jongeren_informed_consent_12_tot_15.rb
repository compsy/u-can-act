...
db_name1 = 'Informed_consent_jongeren_12_tot_15'
...
ic_content = <<~'END'
  <div class="informed-consent">
    ...
    <p>
      Jouw ouder heeft je aangemeld en toestemming gegeven om deel te nemen aan IKIA. Meedoen aan IKIA is vrijwillig. Wel
      is jouw toestemming nodig. Lees daarom deze informatie goed door. Vragen die je misschien hebt kun je stellen
      via <a href="mailto:iederkindisanders@rug.nl">iederkindisanders@rug.nl</a>,
      bijvoorbeeld als je iets niet begrijpt. Als je besluit om geen toestemming te geven voor
      je deelname dan hoeft je niet uit te leggen waarom, en zal dit geen negatieve gevolgen voor je hebben. Je kunt je
      toestemming voor deelname aan het IKIA onderzoek op elk moment weer intrekken.
    </p>
    ...
    <p>
      ...
      een e-mail te sturen via <a href="mailto:iederkindisanders@rug.nl">iederkindisanders@rug.nl</a>. Als je vragen
      of zorgen hebt over je privacy en de omgang met je
      ...
      via <a href="mailto:iederkindisanders@rug.nl">iederkindisanders@rug.nl</a>.
      Als onderzoekdeelnemer heb je recht op een
