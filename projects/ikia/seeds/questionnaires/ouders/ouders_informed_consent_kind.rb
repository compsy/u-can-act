...
ic_content = <<~'END'
  <div class="informed-consent">
    ...
    <p>
      ...
      Als onderzoekdeelnemer heeft u recht op een kopie van deze onderzoek informatie. U kunt de informatie <a href="https://iederkindisanders.nl/ouders/veelgestelde-vragen" target="_blank" rel="noopener noreferrer">hier</a> terugvinden.
    </p>
  </div>
END
