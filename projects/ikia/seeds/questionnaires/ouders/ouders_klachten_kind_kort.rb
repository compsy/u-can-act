...
dagboek_content = [
  {
    ...
    id: :v6,
    type: :range,
    title: 'Is nogal op zichzelf, neigt er toe alleen te spelen.',
    labels: ['Niet waar', 'Een beetje waar', 'Zeker waar'],
    required: true
  }, {
    id: :v7,
    ...
    id: :v22,
    type: :range,
    title: 'Pikt dingen thuis, op school of op andere plaatsen.',
    labels: ['Niet waar', 'Een beetje waar', 'Zeker waar'],
    required: true
  }, {
    id: :v23,
    ...
    hidden: true,
    type: :likert,
    title: 'Maken deze moeilijkheden uw kind overstuur of van slag?',
    ...
    id: :v29,
    type: :likert,
    title: 'Denkt u dat uw kind moeilijkheden heeft om met andere mensen op te schieten?',
    options: [
      {title: 'Nee'},
