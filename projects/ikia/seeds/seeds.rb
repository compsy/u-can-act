...
if Rails.env.development? || Rails.env.staging?
  ...
  child_auth_user.auth0_id_string = 'auth0|5e555e6737de640d5dd40873' # auth id string for parent is "auth0|5e5562e78f02500d6a318732" # auth id string for teen is  "auth0|5e5564fe37de640d5dd4119c"
