...
diary_measurement.period = 1.hour # weekly for 44 weeks
diary_measurement.open_duration = 1.hours # don't allow people to fill it out the next day
diary_measurement.reminder_delay = 20.minutes # send one reminder sunday at noon
