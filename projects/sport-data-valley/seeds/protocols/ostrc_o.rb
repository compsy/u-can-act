...
bp_name = 'base-platform-subscription-ostrc-o'
...
name = 'ostrc_o'
ostrc_questionnaire_id = Questionnaire.find_by(name: name)&.id
raise "Cannot find questionnaire: #{name}" unless ostrc_questionnaire_id
...
db_measurement.open_from_offset = 0 # specified by start_date offset
