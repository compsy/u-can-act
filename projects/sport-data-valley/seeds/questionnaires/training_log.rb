...
dagboek_content = [
  ...
  },
  {
    ...
    options: [
      ...
      { nl: 'Rolschaatsen', en: 'Inline skating', i18n: 'components.dashboards.questionnaire.training_type.inline_skating' },
      ...
      { nl: 'Schaatsplanken', en: 'Slide board skating', i18n: 'components.dashboards.questionnaire.training_type.slide_board_skating' },
