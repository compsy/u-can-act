...
dagboek_content = [
  ...
  },
  {
    ...
    labels: [
      { nl: '0. Rust', en: '0. Rest' },
      { nl: '1. Heel licht', en: '1. Really easy' },
      { nl: '2. Licht', en: '2. Easy' },
      { nl: '3. Gemiddeld', en: '3. Moderate' },
      { nl: '4. Pittig', en: '4. Sort of hard' },
      { nl: '5. Zwaar', en: '5. Hard' },
      { nl: '6.', en: '6.' },
      { nl: '7. Heel zwaar', en: '7. Really hard' },
      { nl: '8.', en: '8.' },
      { nl: '9. Heel, heel zwaar', en: '9. Really, really hard' },
      { nl: '10. Maximaal', en: '10. Maximal' }
    ]
  },
  {
    id: :v7,
