...
diary_protocol.duration = 4.weeks
...
diary_measurement.period = 1.day # weekly for 44 weeks
# diary_measurement.period = 1.week # weekly for 44 weeks
diary_measurement.open_duration = 24.hours # don't allow people to fill it out the next day
...
diary_measurement.reminder_delay = 8.hours # send one reminder sunday at noon
