...
questionnaire_keys = %w[exit_lijst]
...
exit_protocol.invitation_text = 'Fijn dat je meedoet aan het dagboekonderzoek! Klik op de link voor informatie over hoe je je beloning kunt krijgen. Of om door te geven dat je best nog even wil doorgaan.'
