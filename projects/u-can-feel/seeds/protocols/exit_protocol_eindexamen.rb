...
# Uitsturen in juli 2022
questionnaire_keys = %w[exit_lijst_eindexamen]
...
exit_protocol.invitation_text = 'Fijn dat je meedoet aan de dagboekstudie! Het schooljaar eindigt en je krijgt dus binnenkort geen sms-jes meer. Klik op de link voor informatie over hoe je je beloning kunt krijgen!'
