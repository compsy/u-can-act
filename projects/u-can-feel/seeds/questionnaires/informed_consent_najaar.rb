...
db_name1 = 'informed_consent_najaar'
...
ic_content_16_min = <<~'END'
  <div class='informed-consent'>
    ...
    <p>
      ...
      van school). Dit is niet verplicht. Je kunt meedoen aan het onderzoek, ook als je niet wil dat wij deze gegevens van
      de school krijgen.
    </p>
    ...
    <p>
      ...
      onderzoekers gebruiken de antwoorden voor het onderzoek. De resultaten van het onderzoek worden met de scholen en
      met andere onderzoekers gedeeld. Deze resultaten gaan over alle leerlingen, nooit over een specifieke leerling.
    </p>
    <p>
...
ic_footer = <<~'END'
  <p class="flow-text"><em>Je hebt recht op een kopie van dit toestemmingsformulier.</em></p>
END
...
dagboek_content = [
  {
    ...
    options: [
      { title: 'Jonger dan 16 jaar', shows_questions: %i[v2a v3 v4 v5] },
      { title: '16 jaar of ouder', shows_questions: %i[v2b v3 v4 v5] }
    ],
