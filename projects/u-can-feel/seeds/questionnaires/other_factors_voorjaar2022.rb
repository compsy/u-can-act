...
dagboek_content = [
  {
    ...
    type: :radio,
    show_otherwise: false,
    title: "Heb je wel eens alcohol, cannabis (hasj, wiet) of andere drugs (bijvoorbeeld paddo's, cocaïne of GHB) gebruikt?",
    ...
    type: :radio,
    show_otherwise: false,
    title: "Heb je wel eens sigaretten of shag gerookt?",
