...
db_name1 = 'other_factors_voorjaar2023'
...
dagboek_content = [
  {
    ...
    type: :raw,
    content: '<p class="flow-text">De volgende vragen gaan over of je wel eens rookt, alcohol drinkt of drugs gebruikt. We vertellen je antwoorden nooit aan je ouders, je school of anderen. Denk even terug aan <u>de afgelopen maand</u>.
    </p>'
  }, {
    id: :v25_presubstance1,
    type: :radio,
    show_otherwise: false,
    title: "Heb je in de afgelopen maand wel eens alcohol, cannabis (hasj, wiet) of andere drugs (bijvoorbeeld paddo's, cocaïne of GHB) gebruikt?",
    options: [ {title: 'Ja', shows_questions: %i[v25_substance2 v25_substance3 v25_substance4 v25_substance6 v25_substance7 v25_substance8a v25_substance8b v25_substance8c v25_substance8d v25_substance8e v25_substance8f]},
               {title: 'Nee'}]
  }, {
    id: :v25_presubstance2,
    type: :radio,
    show_otherwise: false,
    title: "Heb je in de afgelopen maand wel eens sigaretten of shag gerookt?",
    options: [ {title: 'Ja', shows_questions: %i[v25_substance5]},
               {title: 'Nee'}]
  }, 
  {
    id: :v25_substance2,
    ...
    title: 'Hoeveel dagen dronk je in de afgelopen maand 1 of 2 glazen alcohol?',
    ...
    hidden: true,
    placeholder: 'Selecteer je antwoord...',
    title: 'Hoeveel dagen dronk je in de afgelopen maand 3 of 4 glazen alcohol?',
    options: (0..30).to_a.map(&:to_s)
  }, {
    id: :v25_substance4,
    type: :dropdown,
    ...
    hidden: true,
    placeholder: 'Selecteer je antwoord...',
    title: 'Hoeveel dagen dronk je in de afgelopen maand 5 of meer glazen alcohol?',
    options: (0..30).to_a.map(&:to_s)
  }, {
    id: :v25_substance5,
    type: :dropdown,
    ...
    hidden: true,
    placeholder: 'Selecteer je antwoord...',
    title: 'Hoeveel dagen rookte je sigaretten of shag in de afgelopen maand?',
    options: (0..30).to_a.map(&:to_s)
  }, {
    id: :v25_substance6,
    type: :dropdown,
    ...
    hidden: true,
    placeholder: 'Selecteer je antwoord...',
    title: 'Hoeveel dagen gebruikte je cannabis (hasj, wiet) in de afgelopen maand?',
    options: (0..30).to_a.map(&:to_s)
  }, {
    id: :v25_substance7,
    type: :dropdown,
    ...
    hidden: true,
    placeholder: 'Selecteer je antwoord...',
    title: "Hoeveel dagen gebruikte je een andere drug in de afgelopen maand? Bijvoorbeeld cocaïne, speed, XTC, GHB of paddo's.",
    options: (0..30).to_a.map(&:to_s)
  }, {
    id: :v25_substance8a,
    type: :radio,
    ...
    type: :raw,
    content: '<p class="flow-text">De volgende vragen gaan over gebeurtenissen in de wereld.
    </p>'
  }, {
    id: :v25_news1,
    type: :radio,
    show_otherwise: false,
    title: 'Maak je je wel eens zorgen over onderwerpen uit het nieuws, bijvoorbeeld over oorlog of klimaatsverandering?',
    options: ['Nee, (bijna) nooit', 'Soms', 'Best vaak', 'Heel vaak']
  }, {
    id: :v25_news2,
    type: :radio,
    show_otherwise: false,
    title: 'Ben je wel eens overstuur vanwege zulke onderwerpen uit het nieuws?',
    options: ['Nee, (bijna) nooit', 'Soms', 'Best vaak', 'Heel vaak']
  }, {
    id: :v25_news3,
    type: :radio,
    show_otherwise: false,
    title: 'Hoe vind je dat school omgaat met onderwerpen uit het nieuws?',
    options: ['Docenten hebben het er niet over', 'Docenten hebben het er wel over, maar daar voel ik me alleen maar slechter door', 'Docenten hebben het er wel over, maar dat maakt mij niets uit', 'Docenten hebben het er wel over en dat helpt mij soms', 'Docenten hebben het er wel over en dat helpt mij vaak']
  }, {
    type: :raw,
