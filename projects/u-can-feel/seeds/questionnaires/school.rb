...
dagboek_content = [
  {
    ...
    type: :radio,
    show_otherwise: false,
    title: 'Denk even na over de afgelopen 2 weken. Ongeveer hoeveel halve dagen school heb je gemist? Het maakt niet uit wat de reden was. Als je minder dan een halve dag hebt gemist (bijvoorbeeld één lesuur), geef dan aan dat je een halve dag hebt gemist. Als je alleen een paar minuten te laat was, hoef je het niet mee te tellen.',
    options: [
        { title: 'Ik heb geen lessen gemist' },
        { title: 'Ik heb een halve dag gemist', shows_questions: %i[v29_a] },
        { title: 'Ik heb 1 schooldag gemist', shows_questions: %i[v29_a] },
        { title: 'Ik heb 1.5 tot 2.5 dagen gemist', shows_questions: %i[v29_a] },
        { title: 'Ik heb 3 tot 7 dagen gemist', shows_questions: %i[v29_a] },
        { title: 'Ik heb 7.5 tot 9.5 dagen gemist', shows_questions: %i[v29_a] },
        { title: 'Ik heb alle lessen gemist', shows_questions: %i[v29_a] }
    ]
  }, {
    id: :v29_a,
    type: :checkbox,
