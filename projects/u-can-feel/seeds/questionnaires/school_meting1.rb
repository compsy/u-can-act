...
dagboek_content = [
  {
    ...
    type: :radio,
    show_otherwise: false,
    title: 'Wat voor cijfers heb je het vorig schooljaar meestal gehaald?',
    ...
    show_otherwise: false,
    required: true,
    title: 'Heb je in het afgelopen jaar extra ondersteuning voor je schoolwerk gehad? Je kunt meerdere dingen aankruisen.',
    options: [
    ...
    type: :raw,
    content: '<p class="flow-text">Vanwege de coronacrisis was het vorige schooljaar anders dan anders. Het onderwijs was een tijdje voor een deel of helemaal online. We zijn benieuwd of dit nog steeds gevolgen heeft voor jou op school.
</p>'
  }, {
    id: :v32,
    type: :radio,
