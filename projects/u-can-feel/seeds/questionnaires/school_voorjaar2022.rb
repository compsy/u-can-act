...
dagboek_content = [
  {
    ...
    type: :days,
    show_otherwise: false,
    title: 'Denk even na over de afgelopen 2 weken. Welke dagdelen ben je in de afgelopen 2 weken niet naar school geweest? Het maakt niet uit wat de reden was. Als je minder dan een halve dag hebt gemist (bijvoorbeeld één lesuur), geef dan aan dat je een halve dag hebt gemist. Als je alleen een paar minuten te laat was, hoef je het niet mee te tellen.',
    ...
    type: :raw,
    content: '<p class="flow-text">Vanwege de coronacrisis is school de afgelopen jaren soms anders dan anders geweest. Bijvoorbeeld door quarantaines of door online onderwijs. We zijn benieuwd of dit nog steeds gevolgen heeft voor jou op school.
</p>'
  }, {
    id: :v32,
    type: :radio,
    show_otherwise: false,
    title: "Hoeveel heb je het afgelopen half jaar kunnen leren vergeleken met een gewoon schooljaar?",
    options: ['Veel minder', 'Iets minder', 'Ongeveer even veel', 'Iets meer', 'Veel meer']
  }, {
    id: :v33,
    type: :radio,
    show_otherwise: false,
    title: "Heb je nu meer moeite met school, omdat je de afgelopen jaren misschien dingen hebt gemist door het online onderwijs of door quarantaines?",
