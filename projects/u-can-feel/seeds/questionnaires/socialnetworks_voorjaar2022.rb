...
db_name1 = 'socialnetworks_voorjaar2022'
...
dagboek_content = [
  {
    ...
    type: :radio,
    show_otherwise: false,
    title: 'Voel je je veilig op school?',
    options: ['Zeker niet', 'Meestal niet', 'Soms wel, soms niet', 'Meestal wel', 'Zeker wel']
  }, {
    type: :raw,
    content: '<p class="flow-text">De volgende vragen gaan over grensoverschrijdend gedrag. We hebben het over grensoverschrijdend gedrag als iemand over je grenzen heen gaat. En dingen met je doet die je niet wil. <br><br> Hoe vaak heb je de afgelopen maanden de volgende dingen meegemaakt?
    </p>'
  }, {
    id: :v30,
    type: :radio,
    show_otherwise: false,
    title: 'Iemand heeft jou bedreigd met de bedoeling jou bang te maken',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v31,
    type: :radio,
    show_otherwise: false,
    title: 'Iemand heeft jou bedreigd met de bedoeling iets van jou te stelen',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v32,
    type: :radio,
    show_otherwise: false,
    title: 'Iemand heeft je geïntimideerd of gedwongen iets te doen',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v33,
    type: :radio,
    show_otherwise: false,
    title: 'Iemand heeft je gechanteerd of afgeperst',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v34,
    type: :radio,
    show_otherwise: false,
    title: 'Je hebt online een bericht ontvangen waarmee iemand jou bang probeerde te maken. Bijvoorbeeld via sociale media, email of een online forum/chatbox',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v35,
    type: :radio,
    show_otherwise: false,
    title: 'Je bent door iemand met een wapen bedreigd of bang gemaakt (bijvoorbeeld een stuk hout, een schaar of een mes)',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v36,
    type: :radio,
    show_otherwise: false,
    title: 'Je bent expres door iemand met een wapen verwond (bijvoorbeeld een stuk hout, een schaar of een mes)',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v37,
    type: :radio,
    show_otherwise: false,
    title: 'Er zijn ongewenste seksuele opmerkingen naar jou gemaakt',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v38,
    type: :radio,
    show_otherwise: false,
    title: 'Je bent betast of aangeraakt terwijl je dat niet wilde',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v39,
    type: :radio,
    show_otherwise: false,
    title: 'Je bent gedwongen tot seksuele handelingen',
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v40,
    type: :radio,
    show_otherwise: false,
    title: "Er zijn via internet of telefoon seksueel getinte foto's of filmpjes van jou verspreid terwijl je dat niet wilde",
    options: ['Nooit', 'Minder dan 1x per maand', '1x per maand of vaker', '1x per week of vaker', '1x per dag of vaker']
  }, {
    id: :v41,
    type: :checkbox,
    show_otherwise: false,
    required: true,
    title: 'Wie was er dader van het grensoverschrijdende gedrag dat je hebt meegemaakt? Je kunt meerdere opties aanklikken',
    options: ['Ik heb geen grensoverschrijdend gedrag meegemaakt', 'Andere leerlingen op school', 'Docenten op school', 'Andere volwassenen op school', 'Kinderen of jongeren van buiten school', 'Andere volwassenen van buiten school']
  }
]
