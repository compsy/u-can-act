...
'
  ...
  #
  {
    ...
    content: '
<p class="flow-text section-explanation">
Waarom zit je in een compagnie?
<ul class="flow-text section-explanation">
...
'
  ...
  create_question_seven(:v49, 'Omdat operator zijn past bij alle andere dingen die ik belangrijk vind in het leven.'),
  create_question_seven(:v50, 'Omdat ik een slecht gevoel over mijzelf zou hebben als ik <i>niet</i> operator zou zijn.'),
  create_question_seven(:v51, 'Omdat mensen uit mijn directe omgeving hun afkeuring naar mij zouden uitspreken als ik <i>niet</i> werkzaam ben als operator.'),
  create_question_seven(:v52, 'Omdat operator zijn een goede manier is om aspecten van mijzelf te ontwikkelen die ik waardevol vind.'),
  create_question_seven(:v53, 'Omdat ik er plezier aan beleef om nieuwe acties en strategieën in het werkveld te ontdekken.'),
  create_question_seven(:v54, 'Ik weet het niet meer; ik heb de indruk dat ik niet de kwaliteiten heb om het operator werk succesvol te volbrengen.'),
  create_question_seven(:v55, 'Omdat ik een beter gevoel heb over mijzelf als ik werkzaam ben als operator.'),
  create_question_seven(:v56, 'Omdat mensen uit mijn directe omgeving laten merken dat ze het waarderen dat ik werkzaam ben als operator.'),
  create_question_seven(:v57, 'Omdat het interessant is om te leren hoe ik mijzelf tijdens de werkzaamheden kan verbeteren.'),
  create_question_seven(:v58, 'Omdat operator zijn één van de beste manieren is om verschillende aspecten van mijzelf te ontwikkelen'),
  create_question_seven(:v59, 'Ik weet het niet meer; ik denk dat operator zijn niet echt iets voor mij is.'),
  create_question_seven(:v60, 'Omdat ik door operator te zijn het leven leidt dat helemaal bij mij past.'),
  create_question_seven(:v61, 'Omdat ik me niet waardevol zou voelen als ik niet werkzaam zou zijn als operator.'),
  #
