...
describe EchoPeople do
  ...
  describe 'echo_people' do
    ...
    describe 'with mentors' do
      before do
        allow(CSV).to receive(:foreach)
          .and_yield(%w[type organization_name firstname lastname gender mobile_phone email protocol_name start_date])
          .and_yield(['mentor', 'jouwschool', 'a', 'e', Person::MALE,   '0612345679',  'mentor1@test.com',
                      'protname', dateinfuture, '06-12345670', 'pilot'])
          .and_yield(['mentor', 'jouwschool', 'a', 'e', Person::FEMALE, '0612345679',  'mentor2@test.com',
                      'protname', dateinfuture, '0676543219',  'pilot'])
          .and_yield(['mentor', 'jouwschool', 'b', 'f', Person::MALE,   '06-12345670', 'mentor3@test.com',
                      'protname', dateinfuture, '0676543219',  'pilot'])
          .and_yield(['mentor', 'jouwschool', 'b', 'f', Person::FEMALE, '06-12345670', 'mentor4@test.com',
                      'protname', dateinfuture, '0676543266',  'pilot'])
          .and_yield(['mentor', 'jouwschool', 'b', 'f', Person::MALE,   '06-12345670', 'mentor5@test.com',
                      'protname', dateinfuture, '0676543227',  'pilot'])
      end

      it 'should return an array with all mentors (except the header)' do
        expected_output = "people = [];nil\n"
        expected_output += 'people << {:organization_name=>"jouwschool", :first_name=>"a", :last_name=>"e", ' \
                          ':gender=>"male", :mobile_phone=>"0612345679", ' \
        ...
        expected_output += 'people << {:organization_name=>"jouwschool", :first_name=>"b", :last_name=>"f", ' \
